    ...
    return (
        <section id="about" className="max-w-[1440px] mx-auto py-20 bg-[#F6F6F6] font-sans">
            <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-y-4">
                <h2 className="lg:text-3xl text-2xl font-semibold text-center mb-8 md:hidden font-mono">About Us</h2>
                ...
                <div className="">
                    <h2 className="lg:text-3xl text-2xl font-semibold text-center mb-8 hidden md:block font-mono">About Us</h2>
