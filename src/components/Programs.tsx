...
const Programs = () => {
    return (
        ...
        >
            <div className="col-span-2"><h3 className="lg:text-3xl text-2xl font-bold text-center text-white">Our Programs</h3></div>
            ...
            <div className=" text-white flex flex-col gap-y-2 col-span-2 sm:col-span-1">
                <p className="text-lg mb-4 px-4 text-justify sm:text-left md:pr-24">
                    <b>WISA Football Academy</b> offers a range of sports activities, including basketball, volleyball, tennis, and football. While the academy provides training in all these sports, its primary focus is on football, aiming to develop and nurture young talent in the sport.
                </p>
            </div>
